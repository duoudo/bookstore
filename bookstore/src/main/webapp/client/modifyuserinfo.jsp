...
<body class="main">
	...
	<div id="divpagecontent">
		<form action="${pageContext.request.contextPath}/client/user/modifyuserinfo.do?id=${login_user.id}&username=${login_user.username}" method="post">
						...
						<table width="100%" border="0" cellspacing="0"
							...
							<tr>
								<td class="listtd">
									...
									<a href="${pageContext.request.contextPath}/client/cart/findOrderByUser.do">用户信息修改</a>
								</td>
							</tr>
							<tr>
								<td class="listtd">
								...
								<td>
									<table width="100%" border="0" cellspacing="2" class="upline">
										...
										<tr>
											...
											<td><input type="password" class="textinput" name="password" value="${login_user.password}"/></td>
											<td><font color="#999999">密码设置至少6位，请区分大小写</font></td>
										</tr>
										<tr>
											<td style="text-align:right">重复密码：</td>
											<td><input type="password" class="textinput" name="repassword" value="${login_user.password}"/></td>
											<td>&nbsp;</td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td colspan="2">
												<input  type="text" value="${login_user.telephone}" name="telephone" class="textinput" />
											</td>
										</tr>
										<tr>
