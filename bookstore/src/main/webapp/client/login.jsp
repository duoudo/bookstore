...
<body class="main">
	...
	<div id="divcontent">
		<form action="${pageContext.request.contextPath}/client/user/login.do" method="post">
															...
															<table width="80%" border="0" cellspacing="0"
																...
																<tr>
																	...
																	<td style="text-align:left"><input name="username"
																		type="text" class="textinput" value="${cookie.cookie_username.value}"/>
																	</td>
																</tr>
																<tr>
																	<td style="text-align:right; padding-top:5px">密&nbsp;&nbsp;&nbsp;&nbsp;码：</td>
																	<td style="text-align:left"><input name="password"
																		type="password" class="textinput" value="${cookie.cookie_password.value}"/>
																	</td>
																</tr>
																<tr>
