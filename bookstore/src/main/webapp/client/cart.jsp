...
<%@ taglib prefix="xxx" uri="http://lxy.login-tags"%>
...
<script>
	function changeProductNum(count, totalCount, id) {
		...
		if (count > totalCount) {
			...
			location.href = "${pageContext.request.contextPath}/client/products/changeCartCount.do?id="
					+ id + "&count=" + count;
		}
									...
									<tr>
										<td>
												...
												<table width="100%" border="0" cellspacing="0">
													<tr>
														...
														<td width="20%">
															...
															<input name="text" type="text" value="${entry.value}" style="width:40px;text-align:center" readonly/>
															<input type="button" value='+' style="width:20px"
															onclick="changeProductNum('${entry.value+1}','${entry.key.pnum}','${entry.key.id}')">
														...
														<td width="10%">
															<a href="${pageContext.request.contextPath}/client/products/changeCartCount.do?id=${entry.key.id}&count=0"
															style="color:#fcf6ff; font-weight:bold">X</a>
														</td>
													</tr>
												</table>
											...
											<div style="text-align:right; margin-top:10px">
												<a href="${pageContext.request.contextPath}/client/products/findProduct_listByCategory.do">
